...
class AnalyticsController {
    static async getAnalytics(req, res) {
        try {
            ...
            let analyticsData = await Analytics_1.Analytics.getAggregatedAnalytics(startDate, endDate);
            if (!analyticsData) {
    ...
    static async getRealTimeAnalytics(req, res) {
        try {
            ...
            const todayActivities = await Analytics_1.UserActivity.find({
                timestamp: { $gte: today }
            });
            const yesterdayActivities = await Analytics_1.UserActivity.find({
    ...
    static async trackActivity(req, res) {
        try {
            ...
            const activity = new Analytics_1.UserActivity({
                userId,
                sessionId,
                action,
                resource,
    ...
    static async generateReport(req, res) {
        try {
            ...
            const analyticsData = await Analytics_1.Analytics.getAggregatedAnalytics(startDate, endDate) ||
            ...
            await new Analytics_1.UserActivity({
    ...
    static async getCurrentActiveUsers() {
        try {
            ...
            const activeUsers = await Analytics_1.UserActivity.distinct('userId', {
    ...
    static async generateMockAnalytics(startDate, endDate) {
        return {
            userEngagement: {
                totalUsers: 12847,
                activeUsers: 3421,
    ...
    static async getContentPopularity() {
        return {
            missions: [
    ...
    static async getUserBehaviorPatterns(startDate, endDate) {
        return {
            peakHours: [
